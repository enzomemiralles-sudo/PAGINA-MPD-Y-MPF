...
var clara=/^\\/(ingresar|crear-perfil|elegir-perfil|app|mi-perfil|simulador|asistente|inscripcion|revisar)(\\/|$)/.test(r);
var d=document.documentElement;
d.setAttribute('data-superficie',clara?'clara':'oscura');
var m=clara?'neutro':'dual';
if(/^\\/(app|mi-perfil|simulador|asistente|inscripcion|revisar)(\\/|$)/.test(r)){
