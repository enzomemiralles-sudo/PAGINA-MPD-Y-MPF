...
- [x] **P-16** Los archivos salen de las carpetas de Drive de cada agrupación, no de Storage: cada eje enlaza a su carpeta y un material nuevo aparece con sólo subirlo, sin tocar código. El listado de cada eje es el programa del examen, no un índice del Drive, así que sigue siendo cierto aunque un archivo no esté. Las siete carpetas —seis del MPF, una del MPD— están llenas y verificadas una por una: 20 materiales del MPF y 3 del MPD.
